...
fit <- h2o.deeplearning(y = dependent, x = independent, data = train, 
                        ...
                        rate=0.1,nesterov_accelerated_gradient=T
                        ,max_w2=4,shuffle_training_data=T)
#adaptive_rate=0.9,l1=0.4,l2=0.4,input_dropout_ratio=0.1,rate_decay=0.1,epsilon=0.01,
